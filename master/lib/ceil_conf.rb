...
CEIL_STATUS = {
0 => "ceil started",
10 => "start downloading software package",
15 => "downloading finished, package",
30 => "start installing software package",
...
#for calc progress
CEIL_APP_STATUS_MAX = 75
#steps to install an app
CEIL_APP_INSTALL_STEPS = 8   # et. 10 15 30 35 50 55 70 75
