...
//	private String soft_list = null;
	 ...
	 * @return
	 */
	public Machine(String vdisk_fname, String machine_name, String cpu_count, String mem_size, String soft_list, String sched_to) {
		machinepara = "";
//		machinepara += "machines:\n";
		...
		machinepara += Machine.SCHED_TO + "=" + sched_to + "\n";
	}
