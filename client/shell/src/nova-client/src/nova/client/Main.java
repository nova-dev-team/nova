...
public class Main extends Thread{
	...
	public static void main(String[] args) {
		if( DebugEnv.print_debug_info ) System.out.println("Hello! This is Nova client library, Java version");
...
////		if( DebugEnv.print_debug_info ) System.out.println(vminfo.toString());
//
//		
...
//		while(true) {
//			if( DebugEnv.print_debug_info ) System.out.println("Main");
//			try {
//				sleep(5000);
...
//			if( DebugEnv.print_debug_info ) System.out.println("host_ip: " + addr.getHostAddress());
//			ivmmc.migrateVirtualMachine(vh, addr, mcallback);
////			VM_HANDLE[] avm = ivmmc.getVirtualMachineList(addr);
////			for(int i=0; avm[i]!=null; i++) {
////				if( DebugEnv.print_debug_info ) System.out.println(avm[i].value);
////			}
...
//		}
		...
		if(ivcc.createVM("linux-test3", l)) {
			if( DebugEnv.print_debug_info ) System.out.println("create new vcluster successfully !");
		} else {
			if( DebugEnv.print_debug_info ) System.out.println("create new vcluster failed !");
		}
	}
