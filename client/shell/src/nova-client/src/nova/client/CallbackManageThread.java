...
//				System.out.println(i + tem);
				try {
					...
					if(vs.equals(stopStatus)) {
						if( DebugEnv.print_debug_info ) System.out.println(vs);
...
//				System.out.println(i + tem);
	...
	public static VmachineStatus checkStatus(String uuid, Client client) {
		...
		if(vminfo == null) {
			if( DebugEnv.print_debug_info ) System.out.println("check failed");
			...
			if( DebugEnv.print_debug_info ) System.out.println("statusText: " + statusText);
...
//		while(true){
//			if( DebugEnv.print_debug_info ) System.out.println("Main Thread");
//			try {
//				sleep(1000);
//			} catch (InterruptedException e) {
//				// TODO Auto-generated catch block
