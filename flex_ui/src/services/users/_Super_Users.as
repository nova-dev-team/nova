...
import valueObjects.UserListRep;

import com.adobe.serializers.json.JSONSerializationFilter;

[ExcludeClass]
internal class _Super_Users extends com.adobe.fiber.services.wrapper.HTTPServiceWrapper
{
    ...
    public function _Super_Users()
    {
        ...
        _serviceControl = new mx.rpc.http.HTTPMultiService("http://localhost:3000");
         ...
         operation.url = "/users/list.json";
         operation.method = "GET";
         operation.serializationFilter = serializer0;
         operation.resultType = valueObjects.UserListRep;
    ...
    /**
      ...
      */
    public function listUsers() : mx.rpc.AsyncToken
    {
