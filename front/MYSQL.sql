...
--
-- Definition of table `currentlyloggedin`
--
...
INSERT INTO `currentlyloggedin` (`id`,`session_id`,`member_id`,`group_id`) VALUES 
 (32,'529282793e595b21410fe25d47d3325c','200','1000'),
 (33,'30c2e1ef845ee35e94023e3178ab9430','200','1000'),
 (35,'f1aa44365097aabb749ddbfe3492bd8e','232','10'),
 (36,'95bf425af68f22d8cfb08a2c49eb6155','230','10000'),
 (37,'c61b8fc61a658981be049565a0c3ebe0','230','10000'),
 (40,'9c383a9394dbfa2c99c7898dd648a10e','230','10000'),
 (43,'596f9406e7145c65c5d2fe3bb5a28384','231','1'),
 (44,'813c2653e31d90f4980cded5f3384a1f','231','1'),
 (45,'003160f3b209fe3bd22c56cd2eebb034','232','10'),
 (46,'d964ce98d61d1eb967a06543b215ae20','230','10000'),
 (47,'5649707a9b8924f8bbf9789ba08a2942','200','1000');
/*!40000 ALTER TABLE `currentlyloggedin` ENABLE KEYS */;


--
-- Definition of table `qo_dependencies`
--
...
--
-- Definition of table `qo_domains`
--
...
--
-- Definition of table `qo_domains_has_modules`
--
...
--
-- Definition of table `qo_error_log`
--
...
INSERT INTO `qo_error_log` (`id`,`text`,`timestamp`) VALUES 
 (1,'Script: module.php, Method: find_files, Missing file: system/modules/superadmin-user-manager/superadmin-user-manager-override.js','2009-02-24 14:55:48'),
 ...
 (9,'Script: module.php, Method: find_files, Missing file: system/modules/user-manual/user-manual-override','2009-02-24 15:39:46'),
...
INSERT INTO `qo_groups` (`id`,`name`,`description`,`importance`,`active`) VALUES 
 (1,'administrator','System administrator',50,1),
...
--
-- Definition of table `qo_groups_has_domain_privileges`
--
...
--
-- Definition of table `qo_groups_has_members`
--
...
--
-- Definition of table `qo_launchers`
--
...
--
-- Definition of table `qo_members`
--
...
INSERT INTO `qo_members` (`id`,`first_name`,`last_name`,`email_address`,`password`,`language`,`active`) VALUES 
 (200,'Santa','Zhang','santa','zhang','en',1),
 (232,'debug','debug','debug','debug','en',1),
 (231,'admin','admin','admin','admin','en',1),
 (230,'user','user','user','user','en',1);
/*!40000 ALTER TABLE `qo_members` ENABLE KEYS */;


--
-- Definition of table `qo_members_has_module_launchers`
--
...
--
-- Definition of table `qo_modules`
--
...
INSERT INTO `qo_modules` (`id`,`author`,`version`,`url`,`description`,`module_type`,`module_id`,`active`,`load_on_demand`) VALUES 
 ...
 (102,'Santa Zhang',NULL,NULL,NULL,'admin-manual','admin-manual',1,1),
...
--
-- Definition of table `qo_modules_actions`
--
...
--
-- Definition of table `qo_modules_files`
--
...
INSERT INTO `qo_modules_files` (`qo_modules_id`,`directory`,`file`,`is_stylesheet`,`is_server_module`,`is_client_module`,`class_name`) VALUES 
 ...
 (100,'superadmin-user-manager/','superadmin-user-manager.js',0,0,1,'QoDesk.SuperAdminManagerWindow'),
 ...
 (103,'user-manual/','user-manual.css',1,0,0,''),
...
--
-- Definition of table `qo_modules_has_dependencies`
--
...
--
-- Definition of table `qo_privileges`
--
...
INSERT INTO `qo_privileges` (`id`,`name`,`description`,`is_singular`) VALUES 
 (1,'Load Module','Allows the user access to the loadModule action',0),
...
--
-- Definition of table `qo_privileges_has_module_actions`
--
...
--
-- Definition of table `qo_sessions`
--
...
INSERT INTO `qo_sessions` (`id`,`qo_members_id`,`qo_groups_id`,`ip`,`date`) VALUES 
 ('5952e83912a4c5b176c23a12654335dd',3,3,'127.0.0.1','2008-10-23 03:17:30'),
 ...
 ('853c8f5b6071a765e41df81ba67b8a0f',5,2,'127.0.0.1','2009-02-24 06:55:56'),
 ...
 ('b752bed4801b9ee9a3a5859b08d5fc10',220,2,'127.0.0.1','2009-02-24 07:32:23'),
 ...
 ('c9489aa4d9288cd6592f9d2cd2749563',216,2,'127.0.0.1','2009-02-24 07:57:54'),
 ...
 ('f792c1e6e2fc9bddcaa093652eccba2e',218,2,'127.0.0.1','2009-02-24 08:39:59'),
 ...
 ('c562c3164aad144b903ead6c8f31875a',218,2,'127.0.0.1','2009-02-24 09:01:55'),
 ...
 ('43235bf7a96fc437e60d6eeb888b3074',229,2,'127.0.0.1','2009-02-24 09:28:00'),
 ...
 ('596f9406e7145c65c5d2fe3bb5a28384',231,1,'127.0.0.1','2009-03-11 10:49:00'),
 ...
 ('9c383a9394dbfa2c99c7898dd648a10e',230,10000,'127.0.0.1','2009-03-11 07:21:20'),
 ...
 ('95bf425af68f22d8cfb08a2c49eb6155',230,10000,'127.0.0.1','2009-03-11 06:36:32'),
 ...
 ('d153117401baf617086d730054fbc28e',230,2,'127.0.0.1','2009-02-25 03:19:43'),
 ...
 ('926946dec203d368feebce62d8e648ed',231,1,'127.0.0.1','2009-02-25 13:54:51'),
...
INSERT INTO `qo_styles` (`qo_members_id`,`qo_groups_id`,`qo_themes_id`,`qo_wallpapers_id`,`backgroundcolor`,`fontcolor`,`transparency`,`wallpaperposition`) VALUES 
 (232,9999,1,12,'ffffff','0',100,'center'),
...
--
-- Definition of table `qo_wallpapers`
--
...
--
-- Definition of table `templatemodule`
--
