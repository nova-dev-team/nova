module UserHelper
  ...
  public
    ...
    def UserWorker.info user_email
      result = {}
    ...
    def UserWorker.add_vcluster user_email, vcluster_cid
      result = {}
      user = User.find_by_email user_email
    ...
    def UserWorker.remove_vcluster user_email, vcluster_cid
      result = {}
      user = User.find_by_email user_email
