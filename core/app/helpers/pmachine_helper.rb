module PmachineHelper
  ...
  class Helper
    ...
    def Helper.mark_remove pmachine_ip
      result = {}
    ...
    def Helper.unmark_remove pmachine_ip
      result = {}
      pmachine = Pmachine.find_by_ip pmachine_ip
    ...
    def Helper.host_vmachine pmachine_ip, vmachine_vid
      result = {}
      pmachine = Pmachine.find_by_ip pmachine_ip
    ...
    def Helper.unhost_vmachine pmachine_ip, vmachine_vid
      result = {}
      pmachine = Pmachine.find_by_ip pmachine_ip
