...
private
  ...
  def pmachine_mark_remove pmachine_ip
    result = {}
  ...
  def pmachine_unmark_remove pmachine_ip
    result = {}
    pmachine = Pmachine.find_by_ip pmachine_ip
  ...
  def pmachine_host_vmachine pmachine_ip, vmachine_vid
    result = {}
    pmachine = Pmachine.find_by_ip pmachine_ip
  ...
  def pmachine_unhost_vmachine pmachine_ip, vmachine_vid
    result = {}
    pmachine = Pmachine.find_by_ip pmachine_ip
