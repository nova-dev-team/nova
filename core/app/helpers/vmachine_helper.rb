module VmachineHelper
  ...
  class VmachineWorker

    def VmachineWorker.list
      list = []
      Vmachine.all.each {|vmachine| list << "v#{vmachine.id}"}
      return list
    end

    def VmachineWorker.create
      result = {}
    ...
    def VmachineWorker.delete vmachine_vid
      result = {}
    ...
    def VmachineWorker.info vmachine_vid
      result = {}
      vmachine = Vmachine.find_by_id vmachine_vid[1..-1] if vmachine_vid != nil
    ...
    def VmachineWorker.start vmachine_vid
      result = {}
      vmachine = Vmachine.find_by_id vmachine_vid[1..-1] if vmachine_vid != nil
      ...
      if vmachine == nil # vmachine not found
        ...
        if vmachine.status != "not running" # not in correct status
          ...
          if hosting_pmachine == nil # pmachine not found
            ...
            sub_result = PmachineHelper::PmachineWorker.host_vmachine hosting_pmachine.ip, "v#{vmachine.id}"
    ...
    def VmachineWorker.stop vmachine_vid
      result = {}
      vmachine = Vmachine.find_by_id vmachine_vid[1..-1] if vmachine_vid != nil
    ...
    def VmachineWorker.suspend vmachine_vid
      result = {}
      vmachine = Vmachine.find_by_id vmachine_vid[1..-1] if vmachine_vid != nil
    ...
    def VmachineWorker.resume vmachine_vid
      result = {}
      vmachine = Vmachine.find_by_id vmachine_vid[1..-1] if vmachine_vid != nil
    ...
    def VmachineWorker.notify_status_change vmachine_vid, new_status
      result = {}
      vmachine = Vmachine.find_by_id vmachine_vid[1..-1] if vmachine_vid != nil
