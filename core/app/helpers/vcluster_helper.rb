module VclusterHelper
  ...
  class VclusterWorker

    # list all the vclusters
    def VclusterWorker.list
      list = []
    ...
    def VclusterWorker.delete vcluster_cid
      result = {}
    ...
    def VclusterWorker.add_vmachine vcluster_cid, vmachine_vid
      result = {}
      vcluster = Vcluster.find_by_id vcluster_cid[1..-1] if vcluster_cid != nil
    ...
    def VclusterWorker.remove_vmachine vcluster_cid, vmachine_vid
      result = {}
      vcluster = Vcluster.find_by_id vcluster_cid[1..-1] if vcluster_cid != nil
    ...
    def VclusterWorker.info vcluster_cid
      result = {}
      vcluster = Vcluster.find_by_id vcluster_cid[1..-1] if vcluster_cid != nil
